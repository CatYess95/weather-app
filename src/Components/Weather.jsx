...
const Weather = () => {
    ...
    return (
        <div className='container'>
            ...
            <h1>WEATHER  APP</h1>
            <h2><img className="geo" src="./src/assets/icon/geo.png"/>
             {weather.name}, {weather.sys?.country}</h2>
            <img src={`http://openweathermap.org/img/wn/${weather.weather?.[0].icon}@2x.png`} alt="" />
            <h1>{kelvin ? celsius : fahrenheit} {kelvin ? "°C" : "°F"} </h1>
            <h2>"{weather.weather?.[0].description}"</h2>
            <h3><img className="wind" src="./src/assets/icon/wind.png"/> Wind speed: {weather.wind?.speed} m/s</h3>
            <h3><img className="cloudy" src="./src/assets/icon/cloudy.png" alt="" />  Clouds: {weather.clouds?.all}%</h3>
            <h3><img className="humidity" src="./src/assets/icon/humidity.png" alt="" />  Humidity: {weather.main?.humidity}%</h3>
            <h3><img className="pressure" src="./src/assets/icon/pressure.png" alt="" /> Pressure: {weather.main?.pressure} mbar</h3>
